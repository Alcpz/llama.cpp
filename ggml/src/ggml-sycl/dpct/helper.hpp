...
#define PITCH_DEFAULT_ALIGN(x) (((x) + 31) & ~(0x1F))
    ...
    SYCL_EXTERNAL extern "C" int __builtin_IB_dp4a_us(int c, int a, int b) __attribute__((const));
    SYCL_EXTERNAL extern "C" int __builtin_IB_dp4a_su(int c, int a, int b) __attribute__((const));
    SYCL_EXTERNAL extern "C" int __builtin_IB_dp4a_uu(int c, int a, int b) __attribute__((const));
#endif
